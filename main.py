...
class NumatoMgr:
    def __init__(self):
        ...
        self.mainwindow.iconbitmap(self.get_icon_path("numato_icon.ico"))        
        ...
        # Manual Test Button
        self.manual_button_img = PhotoImage(file=self.get_cover_path("manual.png"))
        ...
        self.auto_button_img = PhotoImage(file=self.get_cover_path("auto.png"))
    ...
    def get_icon_path(self, path: str) -> Path:
        return ICON_PATH / Path(path)

    def get_cover_path(self, path: str) -> Path:
