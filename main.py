...
class NumatoMgr:
    def __init__(self):
        root = Tk()
        self.root = root        
        self.root.title("Numato Manager")
        self.root.iconbitmap(cmn.get_icon_path("numato_icon.ico"))        
        ...
        self.manual_button = Button(image=self.manual_button_img, borderwidth=0, highlightthickness=0, command=lambda: mt.on_btn_click(self.root), relief="flat", background="#FF0000")
        ...
        self.auto_button = Button(image=self.auto_button_img, borderwidth=0, highlightthickness=0, command=lambda: at.on_btn_click(self.root), relief="flat", background="#0000FF")
