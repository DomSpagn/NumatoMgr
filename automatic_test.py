...
class AutomaticTestPanel:
    ...
    def set_relay_0_button(self):
        ...
        self.button_relay_0.place(x=165.0, y=306.0, width=30.0, height=30.0)
    ...
    def set_relay_1_button(self):
        ...
        self.button_relay_1.place(x=205.0, y=306.0, width=30.0, height=30.0)
    ...
    def set_relay_2_button(self):
        ...
        self.button_relay_2.place(x=245.0, y=306.0, width=30.0, height=30.0)
    ...
    def set_relay_3_button(self):
        ...
        self.button_relay_3.place(x=285.0, y=306.0, width=30.0, height=30.0)
    ...
    def set_relay_4_button(self):
        ...
        self.button_relay_4.place(x=165.0, y=346.0, width=30.0, height=30.0)
    ...
    def set_relay_5_button(self):
        ...
        self.button_relay_5.place(x=205.0, y=346.0, width=30.0, height=30.0)
    ...
    def set_relay_6_button(self):
        ...
        self.button_relay_6.place(x=245.0, y=346.0, width=30.0, height=30.0)
    ...
    def set_relay_7_button(self):
        ...
        self.button_relay_7.place(x=285.0, y=346.0, width=30.0, height=30.0)
    ...
    def set_relay_8_button(self):
        ...
        self.button_relay_8.place(x=165.0, y=386.0, width=30.0, height=30.0)
    ...
    def set_relay_9_button(self):
        ...
        self.button_relay_9.place(x=205.0, y=386.0, width=30.0, height=30.0)
    ...
    def set_relay_10_button(self):
        ...
        self.button_relay_10.place(x=245.0, y=386.0, width=30.0, height=30.0)
    ...
    def set_relay_11_button(self):
        ...
        self.button_relay_11.place(x=285.0, y=386.0, width=30.0, height=30.0)
    ...
    def set_relay_12_button(self):
        ...
        self.photo_var_relay_12 = PhotoImage(file=self.img_paths_relay_12[self.current_relay_img_idx[12]])
        ...
        self.button_relay_12.place(x=165.0, y=426.0, width=30.0, height=30.0)
    ...
    def set_relay_13_button(self):
        ...
        self.button_relay_13.place(x=205.0, y=426.0, width=30.0, height=30.0)
    ...
    def set_relay_14_button(self):
        ...
        self.photo_var_relay_14 = PhotoImage(file=self.img_paths_relay_14[self.current_relay_img_idx[14]])
        ...
        self.button_relay_14.place(x=245.0, y=426.0, width=30.0, height=30.0)
    ...
    def set_relay_15_button(self):
        ...
        self.button_relay_15.place(x=285.0, y=426.0, width=30.0, height=30.0)
    ...
    def set_gpio_1_button(self):
        ...
        self.button_gpio_1.place(x=147.0, y=698.0, width=36.0, height=36.0)
    ...
    def set_gpio_2_button(self):
        ...
        self.button_gpio_2.place(x=170.0, y=648.0, width=36.0, height=36.0)
    ...
    def set_gpio_3_button(self):
        ...
        self.button_gpio_3.place(x=222.0, y=623.0, width=36.0, height=36.0)
    ...
    def set_gpio_4_button(self):
        ...
        self.button_gpio_4.place(x=271.0, y=648.0, width=36.0, height=36.0)
    ...
    def set_gpio_5_button(self):
        ...
        self.button_gpio_5.place(x=296.0, y=698.0, width=36.0, height=36.0)
    ...
    def set_gpio_6_button(self):
        ...
        self.button_gpio_6.place(x=271.0, y=747.0, width=36.0, height=36.0)
    ...
    def set_gpio_7_button(self):
        ...
        self.button_gpio_7.place(x=222.0, y=773.0, width=36.0, height=36.0)
    ...
    def set_gpio_8_button(self):
        ...
        self.button_gpio_8.place(x=170.0, y=747.0, width=36.0, height=36.0)
...
class AutomaticTestSection:
    ...
    def invert_gpios_init_condition(self):
        ...
        self.gpio_1 = self.canvas.create_image(372.0, 659.0, image=self.gpio_img_0)
        ...
        self.gpio_2 = self.canvas.create_image(604.0, 659.0, image=self.gpio_img_1)
        ...
        self.gpio_3 = self.canvas.create_image(836.0, 659.0, image=self.gpio_img_2)
        ...
        self.gpio_4 = self.canvas.create_image(1068.0, 659.0, image=self.gpio_img_3)
        ...
        self.gpio_5 = self.canvas.create_image(372.0, 835.0, image=self.gpio_img_4)
        ...
        self.gpio_6 = self.canvas.create_image(604.0, 835.0, image=self.gpio_img_5)
        ...
        self.gpio_7 = self.canvas.create_image(836.0, 835.0, image=self.gpio_img_6)
        ...
        self.gpio_8 = self.canvas.create_image(1068.0, 835.0, image=self.gpio_img_7)  
