...
class AutomaticTestPanel:
    def __init__(self, cover_window):
        ...
        self.button_img_relay_1 = PhotoImage(file=cmn.get_panel_path(self.type, "relay_1_off.png"))
        self.button_relay_1 = Button(image=self.button_img_relay_1, borderwidth=0, highlightthickness=0, command=lambda: cmn.set_relay_config(self, 1, 'off'), relief="flat")
        self.button_relay_1.place(x=165.0, y=306.0, width=30.0, height=30.0)

        self.button_img_relay_2 = PhotoImage(file=cmn.get_panel_path(self.type, "relay_2_off.png"))
        self.button_relay_2 = Button(image=self.button_img_relay_2, borderwidth=0, highlightthickness=0, command=lambda: cmn.set_relay_config(self, 2, 'off'), relief="flat")
        self.button_relay_2.place(x=205.0, y=306.0, width=30.0, height=30.0)

        self.button_img_relay_3 = PhotoImage(file=cmn.get_panel_path(self.type, "relay_3_off.png"))
        self.button_relay_3 = Button(image=self.button_img_relay_3, borderwidth=0, highlightthickness=0, command=lambda: cmn.set_relay_config(self, 3, 'off'), relief="flat")
        self.button_relay_3.place(x=245.0, y=306.0, width=30.0, height=30.0)

        self.button_img_relay_4 = PhotoImage(file=cmn.get_panel_path(self.type, "relay_4_off.png"))
        self.button_relay_4 = Button(image=self.button_img_relay_4, borderwidth=0, highlightthickness=0, command=lambda: cmn.set_relay_config(self, 4, 'off'), relief="flat")
        self.button_relay_4.place(x=285.0, y=306.0, width=30.0, height=30.0)

        self.button_img_relay_5 = PhotoImage(file=cmn.get_panel_path(self.type, "relay_5_off.png"))
        self.button_relay_5 = Button(image=self.button_img_relay_5, borderwidth=0, highlightthickness=0, command=lambda: cmn.set_relay_config(self, 5, 'off'), relief="flat")
        self.button_relay_5.place(x=165.0, y=346.0, width=30.0, height=30.0)

        self.button_img_relay_6 = PhotoImage(file=cmn.get_panel_path(self.type, "relay_6_off.png"))
        self.button_relay_6 = Button(image=self.button_img_relay_6, borderwidth=0, highlightthickness=0, command=lambda: cmn.set_relay_config(self, 6, 'off'), relief="flat")
        self.button_relay_6.place(x=205.0, y=346.0, width=30.0, height=30.0)

        self.button_img_relay_7 = PhotoImage(file=cmn.get_panel_path(self.type, "relay_7_off.png"))
        self.button_relay_7 = Button(image=self.button_img_relay_7, borderwidth=0, highlightthickness=0, command=lambda: cmn.set_relay_config(self, 7, 'off'), relief="flat")
        self.button_relay_7.place(x=245.0, y=346.0, width=30.0, height=30.0)

        self.button_img_relay_8 = PhotoImage(file=cmn.get_panel_path(self.type, "relay_8_off.png"))
        self.button_relay_8 = Button(image=self.button_img_relay_8, borderwidth=0, highlightthickness=0, command=lambda: cmn.set_relay_config(self, 8, 'off'), relief="flat")
        self.button_relay_8.place(x=285.0, y=346.0, width=30.0, height=30.0)

        self.button_img_relay_9 = PhotoImage(file=cmn.get_panel_path(self.type, "relay_9_off.png"))
        self.button_relay_9 = Button(image=self.button_img_relay_9, borderwidth=0, highlightthickness=0, command=lambda: cmn.set_relay_config(self, 9, 'off'), relief="flat")
        self.button_relay_9.place(x=165.0, y=386.0, width=30.0, height=30.0)

        self.button_img_relay_10 = PhotoImage(file=cmn.get_panel_path(self.type, "relay_10_off.png"))
        self.button_relay_10 = Button(image=self.button_img_relay_10, borderwidth=0, highlightthickness=0, command=lambda: cmn.set_relay_config(self, 10, 'off'), relief="flat")
        self.button_relay_10.place(x=205.0, y=386.0, width=30.0, height=30.0)

        self.button_img_relay_11 = PhotoImage(file=cmn.get_panel_path(self.type, "relay_11_off.png"))
        self.button_relay_11 = Button(image=self.button_img_relay_11, borderwidth=0, highlightthickness=0, command=lambda: cmn.set_relay_config(self, 11, 'off'), relief="flat")
        self.button_relay_11.place(x=245.0, y=386.0, width=30.0, height=30.0)

        self.button_img_relay_12 = PhotoImage(file=cmn.get_panel_path(self.type, "relay_12_off.png"))
        self.button_relay_12 = Button(image=self.button_img_relay_12, borderwidth=0, highlightthickness=0, command=lambda: cmn.set_relay_config(self, 12, 'off'), relief="flat")
        self.button_relay_12.place(x=285.0, y=386.0, width=30.0, height=30.0)

        self.button_img_relay_13 = PhotoImage(file=cmn.get_panel_path(self.type, "relay_13_off.png"))
        self.button_relay_13 = Button(image=self.button_img_relay_13, borderwidth=0, highlightthickness=0, command=lambda: cmn.set_relay_config(self, 13, 'off'), relief="flat")
        self.button_relay_13.place(x=165.0, y=426.0, width=30.0, height=30.0)

        self.button_img_relay_14 = PhotoImage(file=cmn.get_panel_path(self.type, "relay_14_off.png"))
        self.button_relay_14 = Button(image=self.button_img_relay_14, borderwidth=0, highlightthickness=0, command=lambda: cmn.set_relay_config(self, 14, 'off'), relief="flat")
        self.button_relay_14.place(x=205.0, y=426.0, width=30.0, height=30.0)

        self.button_img_relay_15 = PhotoImage(file=cmn.get_panel_path(self.type, "relay_15_off.png"))
        self.button_relay_15 = Button(image=self.button_img_relay_15, borderwidth=0, highlightthickness=0, command=lambda: cmn.set_relay_config(self, 15, 'off'), relief="flat")
        self.button_relay_15.place(x=245.0, y=426.0, width=30.0, height=30.0)

        self.button_img_relay_16 = PhotoImage(file=cmn.get_panel_path(self.type, "relay_16_off.png"))
        self.button_relay_16 = Button(image=self.button_img_relay_16, borderwidth=0, highlightthickness=0, command=lambda: cmn.set_relay_config(self, 16, 'off'), relief="flat")
